...
var Layout = function (_Component) {
  ...
  _createClass(Layout, [{
    ...
    value: function initCMS() {
      ...
      (0, _whatwgFetch2.default)(endpoint, { method: 'GET' }).then(function (json) {
        return json.json();
      }).then(function (res) {
        var menuItems = [];
    ...
    value: function uploadImage(e) {
      ...
      if (e.currentTarget.files[0]) {
        ...
        (0, _whatwgFetch2.default)(endpoint, { method: 'POST', body: fd }).catch(function (err) {
          throw new Error('error: ' + err);
        });
      }
    }
    ...
    value: function uploadFile(file) {
      ...
      var fd = new FormData();
      fd.append('file', fileFromInput, [fileFromInput.name, folderPath]);
      return (0, _whatwgFetch2.default)(endpoint, { method: 'POST', body: fd });
    }
  }, {
    key: 'test',
    value: function test() {
